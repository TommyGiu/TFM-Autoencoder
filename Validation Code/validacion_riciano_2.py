...
modelo_1 = load_model ('modelos\modelo1_riciano_2.h5')
modelo_2 = load_model ('modelos\modelo2_riciano_2.h5')
modelo_3 = load_model ('modelos\modelo3_riciano_2.h5')
modelo_4 = load_model ('modelos\modelo4_riciano_2.h5')
unet = load_model (r'modelos\Unet_riciano_2.h5')

# =============================================================================
#            CARGA X_TEST_GAUSS_2 (IMAGENES CON RUIDO PARA VALIDACIÓN)
# =============================================================================

x_val = np.load (r'datos\test_riccian_2.npy')

x_val = x_val.reshape(-1, 320,320, 1) #Añadimos la dimension color

x_val_plot = x_val.reshape(-1, 320,320) # Lo usaremos en el plot
...
error = r2_score(predict_1d, y_test_1d) # r2 = 0.84
...
for salida,real,inicial in zip (predict_plot[0:5],y_test_plot[0:5], x_val_plot[0:5]):
...
error = r2_score(predict_1d, y_test_1d) # r2 = 0.85
...
# =============================================================================
#                         UNET: PREDICCIONES Y R2
# =============================================================================


predict = unet.predict(x_val)

predict_1d = predict.flatten()

error = r2_score(predict_1d, y_test_1d) # r2 = 0.42
