...
modelo_1 = load_model ('modelos\modelo1_riciano.h5')
modelo_2 = load_model ('modelos\modelo2_riciano.h5')
modelo_3 = load_model ('modelos\modelo3_riciano.h5')
modelo_4 = load_model ('modelos\modelo4_riciano.h5')
unet = load_model (r'modelos\Unet_riciano.h5')

# =============================================================================
#            CARGA X_TEST_GAUSS_2 (IMAGENES CON RUIDO PARA VALIDACIÓN)
# =============================================================================

x_val = np.load (r'datos\test_riccian.npy')
...
error = r2_score(predict_1d, y_test_1d) # r2 = 0.94
...
error = r2_score(predict_1d, y_test_1d) # r2 = 0.37
