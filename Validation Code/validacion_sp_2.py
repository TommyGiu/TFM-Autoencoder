...
modelo_1 = load_model ('modelos\modelo1_saltandpepper_2.h5')
modelo_2 = load_model ('modelos\modelo2_saltandpepper_2.h5')
modelo_3 = load_model ('modelos\modelo3_saltandpepper_2.h5')
modelo_4 = load_model ('modelos\modelo4_saltandpepper_2.h5')

# =============================================================================
#            CARGA X_TEST_GAUSS_2 (IMAGENES CON RUIDO PARA VALIDACIÓN)
# =============================================================================

x_val = np.load (r'datos\x_test_sep_2.npy')
...
error = r2_score(predict_1d, y_test_1d) # r2 = 0.72
