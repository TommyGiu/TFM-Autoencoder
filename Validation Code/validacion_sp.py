...
modelo_1 = load_model ('modelos\modelo1_saltandpepper.h5')
modelo_2 = load_model ('modelos\modelo2_saltandpepper.h5')
modelo_3 = load_model ('modelos\modelo3_saltandpepper.h5')
modelo_4 = load_model ('modelos\modelo4_saltandpepper.h5')

# =============================================================================
#            CARGA X_TEST_GAUSS_2 (IMAGENES CON RUIDO PARA VALIDACIÓN)
# =============================================================================

x_val = np.load (r'datos\x_test_sep.npy')
