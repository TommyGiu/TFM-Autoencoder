...
modelo_1 = load_model ('modelos\modelo1_gauss_2.h5')
modelo_2 = load_model ('modelos\modelo2_gauss_2.h5')
modelo_3 = load_model ('modelos\modelo3_gauss_2.h5')
modelo_4 = load_model ('modelos\modelo4_gauss_2.h5')
...
x_val = np.load (r'datos\x_test_gauss_2.npy')
...
error = r2_score(predict_1d, y_test_1d) # r2 = 0.93
...
error = r2_score(predict_1d, y_test_1d) # r2 = 0.78
